package com.example.agricultureguide;
...
import com.example.agricultureguide.adapters.pagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    String CITY = "Dehradun,India";
    String API = "6b5680d9f09fa185703b6b171597a157";
    ...
    private void cntDefntion() {
    mViewPager = findViewById(R.id.infoViewPager);
    adapter = new pagerAdapter(this,infoList);
    prepareInfoList();
